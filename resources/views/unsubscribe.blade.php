...
<body>
        ...
        <div class="inner-container">
            <svg id="svg" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 590 484.7">
                ...
                <g id="confetti" class="confetti">
                    ...
                    <circle cx="294.1" cy="243.6" r="12" fill="none" stroke="#fff"
                        stroke-miterlimit="10" stroke-width="2" />
                    <circle cx="294.2" cy="243.6" r="12" fill="#fff" />
                    <circle cx="294.2" cy="243.6" r="12" fill="none" stroke="#fff"
                        stroke-miterlimit="10" stroke-width="2" />
                    <circle cx="294.2" cy="243.6" r="12" fill="none" stroke="#d960ae"
                        stroke-miterlimit="10" stroke-width="2" />
                    <circle cx="294.2" cy="243.6" r="12" fill="none" stroke="#d960ae"
                        stroke-miterlimit="10" stroke-width="2" />
                    <circle cx="295.9" cy="242.1" r="12" fill="none" stroke="#543093"
                        stroke-miterlimit="10" stroke-width="2" />
                    <circle cx="295.9" cy="242.1" r="12" fill="none" stroke="#543093"
                        stroke-miterlimit="10" stroke-width="2" />
                ...
                <g id="envelope">
                    ...
                    <g id="paper-group">
                        <rect id="paper" x="157.3" y="87.6" width="275.3" height="266.33"
                            rx="26" ry="26" fill="#fff" stroke="#543093" stroke-miterlimit="10"
                            stroke-width="5" />
                        <g id="face">
                            <g id="mouth">
            ...
            <div class="bottom">
                ...
                <div class="buttons">
                    ...
                    <form method="post" id="unForm">


                        <label for="reason01">
                            <div class="checkbox-wrapper-31">
                                <input type="checkbox" id="reason01" name="reason[]"
                                    value="Content was irrelevant">
                            ...
                            </div>Content was irrelevant
                        </label>
                        <label for="reason02">
                            <div class="checkbox-wrapper-31">
                                <input type="checkbox" id="reason02" name="reason[]"
                                    value="Received too frequently">
                                <svg viewBox="0 0 35.6 35.6">
                                    <circle class="background" cx="17.8" cy="17.8" r="17.8">
                                    </circle>
                                    <circle class="stroke" cx="17.8" cy="17.8" r="14.37"></circle>
                            ...
                            </div>Received too frequently
                        </label>
                        <label for="reason03">
                            <div class="checkbox-wrapper-31">
                                <input type="checkbox" id="reason03" name="reason[]"
                                    value="Didn't recall signing up">
                                <svg viewBox="0 0 35.6 35.6">
                                    <circle class="background" cx="17.8" cy="17.8" r="17.8">
                                    </circle>
                                    <circle class="stroke" cx="17.8" cy="17.8" r="14.37"></circle>
                            ...
                            </div>Didn't recall signing up
                        </label>
                        <label for="reason04">
                            <div class="checkbox-wrapper-31">
                                <input type="checkbox" id="reason04" name="reason[]" value="Privacy concerns">
                                <svg viewBox="0 0 35.6 35.6">
                                    <circle class="background" cx="17.8" cy="17.8" r="17.8">
                                    </circle>
                                    <circle class="stroke" cx="17.8" cy="17.8" r="14.37"></circle>
                            ...
                            </div>Privacy concerns
                        </label>
                        <input id="untype" type="hidden" name="type">
    ...
    <script>
        ...
        const untype = document.querySelector('#untype')
        const subForm = document.querySelector('#unForm')
        unSubBtn.addEventListener('click', (e) => {
            untype.value = "unsubscribe"
            subForm.submit();

        })
        notSubBtn.addEventListener('click', (e) => {
            untype.value = "notice"
            subForm.submit();
