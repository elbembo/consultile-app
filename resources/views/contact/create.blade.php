    ...
    <div class="container-fluid py-4">
        ...
        <div class="card  mx-4">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form action="{{ isset($contact->id) ? '/contacts/'.$contact->id : '/contacts' }}" method="POST" role="form text-left">
                    @csrf
                    @if(isset($contact))
                    @method('PUT')
                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('email') border border-danger rounded-3 @enderror">
                                    <input class="form-control"
                                     ...
                                     type="email" placeholder="{{ isset($contact->email) ? secret($contact->email) : '' }}" id="caontact-email" name="email">
                                    @error('email')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6 row">
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="@error('work_phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="tel" placeholder="{{ isset($contact->work_phone) ? secret($contact->work_phone) : '' }}" id="work-phone" name="work_phone" 
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="@error('personal_phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" data-default="@can('secret.contacts'){{ $contact->personal_phone ?? ''}} @endcan" type="tel" placeholder="{{ isset($contact->personal_phone) ? secret($contact->personal_phone) : '' }}" id="personal-phone" name="personal_phone" value="@can('secret.contacts'){{ $contact->personal_phone ?? ''}} @endcan">
