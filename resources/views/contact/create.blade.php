    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/contacts" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6 row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="@error('first_name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $caontact->first_name ?? '' }}" type="text" placeholder="Name" id="user-name" name="first_name">
                                    @error('first_name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="@error('last_name') border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $caontact->last_name ?? '' }}" type="text" placeholder="Last Name" id="user-name" name="last_name">
                                    @error('last_name')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('email') border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $caontact->email ?? '' }}" type="email" placeholder="name@company.com" id="caontact-email" name="email">
                                    @error('email')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6 row">
                            <div class="form-group col-md-6 ">
                                ...
                                <div class="@error('work_phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="tel" placeholder="010xxxxxxxxx" id="work-phone" name="work_phone" value="{{  $contact->work_phone ?? '' }}">
                                    @error('work_phone')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
