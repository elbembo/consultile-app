...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" data-color="dark">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (str_contains(url()->current(), 'contacts') ? 'active' : '') }} " href="{{ url('contacts') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{  (str_contains(url()->current(), 'campaigns') ? 'active' : '') }}" href="{{ url('campaigns') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (str_contains(url()->current(), 'campaigns') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Campaigns</span>
        </a>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{  (str_contains(url()->current(), 'email/templates') ? 'active' : '') }}" href="{{ url('email/templates') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (str_contains(url()->current(), 'email/templates')  ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <!-- <li class="nav-link mb-0">
        <a href="#" class="nav-link " target="_blank" role="button" aria-pressed="true">
            sub menu</a>
            <ul>
                <li class="nav-link mb-0"><a href="#" ></a></li>
            </ul>
      </li> -->
    </ul>
  </div>
