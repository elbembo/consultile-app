                ...
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ url('campaigns/create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                type="button">
                                {{ '+ New Campaigns' }}</a>
                        </div>
                                    ...
                                    <li class="col-md-6 d-inline">
                                        <div class=" border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg ">
                                            <div class="d-flex flex-column">
                                                <h6 class="mb-3 text-sm">{{ $campaign->name }}
                                                    <form action="{{ url('campaigns/' . $campaign->id) }}" method="post"
                                                        ...
                                                        @if ($campaign->status == 'processing')
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-link text-dark p-0 mb-0 text-lg">
                                                                <i class="fa fa-pause-circle-o me-2"></i>
                                                            </button>
                                                        @elseif($campaign->status == 'pause')
                                                            <input type="hidden" name="status" value="resume">
                                                            <button type="submit"
                                                                class="btn btn-link text-dark p-0 mb-0 text-lg">
                                                                <i class="fa fa-play-circle-o me-2"></i>
                                                            </button>
                                                        @endif
                                                    </form>
                                                </h6>
                                                <span class="mb-2 text-xs">Status: {!! statusBadg(
                                                    $campaign->status,
                                                    ' text-white
                                                                                                                                                                                        ms-sm-2 font-weight-bold',
                                                ) !!}</span>
                                                <span class="mb-2 text-xs">Sent: <span
                                                ...
                                                <span class="text-xs">Priority: <span
                                                        class="text-dark ms-sm-2 font-weight-bold">{!! priority($campaign->campaign_priority) !!}</span></span>
                                            </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    @if ($campaign->status == 'completed' || $campaign->status == 'processing')
                                                        <a class="btn btn-link text-success px-3 mb-0"
                                                            ...
                                                            <i class="fas  fa-eye text-success me-2"
                                                                aria-hidden="true"></i>View
                                                        </a>
                                                    @else
                                                        <form action="{{ url('campaigns/' . $campaign->id) }}"
