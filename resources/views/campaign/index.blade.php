            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{url('campaigns/create')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New User</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{url('contacts/1/edit')}}" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Edit user">
