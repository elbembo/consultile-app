...
<head>
    ...
    <link href="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/css/nucleo-svg.css" rel="stylesheet">

    <link id="pagestyle"
        href="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/css/soft-ui-dashboard.css?v=1.0.4"
        rel="stylesheet">
</head>
                        ...
                        <div class="col-12">
                            ...
                            <nav
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ps ps--active-x ps--active-y"
                                        id="navigation">
                                        <ul class="navbar-nav navbar-nav-hover mx-auto">
                                            <li class="nav-item dropdown dropdown-hover mx-2">
                                                <a role="button"
                                                    ...
                                                    aria-expanded="false">
                                                    Pages
                                                    <img src=" https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/down-arrow-dark.svg"
                                                        alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
                                                    <img src="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/down-arrow-dark.svg"
                                                        alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
                                                </a>
                                                        ...
                                                        <div class="col-12 px-4 py-2">
                                                            <div class="row">
                                                                <div class="col-4 position-relative">
                                                                    ...
                                                                    <a href="/dashboard-automative"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Automotive</span>
                                                                    </a>
                                                                    <a href="/dashboard-smart-home"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Smart Home</span>
                                                                    </a>
                                                                    <a href="/dashboard-virtual-default"
                                                                        class="dropdown-item border-radius-md">
                                                                    ...
                                                                    <a href="/pages-users-reports"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Reports</span>
                                                                    </a>
                                                                    <a href="/pages-users-new"
                                                                        class="dropdown-item border-radius-md">
                                                                ...
                                                                <div class="col-4 position-relative">
                                                                    ...
                                                                    <a href="/pages-profile-overview"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Overview</span>
                                                                    </a>
                                                                    <a href="/pages-profile-teams"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Teams</span>
                                                                    </a>
                                                                    <a href="/pages-profile-projects"
                                                                        class="dropdown-item border-radius-md">
                                                                    ...
                                                                    <a href="/pages-projects-general"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">General</span>
                                                                    </a>
                                                                    <a href="/pages-projects-timeline"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Timeline</span>
                                                                    </a>
                                                                    <a href="/pages-projects-new-project"
                                                                        class="dropdown-item border-radius-md">
                                                                ...
                                                                <div class="col-4">
                                                                    ...
                                                                    <a href="/pages-account-billing"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Billing</span>
                                                                    </a>
                                                                    <a href="/pages-account-invoice"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Invoice</span>
                                                                    </a>
                                                                    <a href="/pages-account-security"
                                                                        class="dropdown-item border-radius-md">
                                            ...
                                            <li class="nav-item dropdown dropdown-hover mx-2">
                                                <a role="button"
                                                    class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center "
                                                    id="dropdownMenuAccount" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    Authentication
                                                    <img src=" https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/down-arrow-dark.svg"
                                                        alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3"
                                                    ...
                                                    <div class="row d-none d-lg-flex">
                                                        <div class="col-6">
                                                            <div class="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image"
                                                                ...
                                                                <div class="mask bg-gradient-primary border-radius-lg">
                                                                </div>
                                                                <div
                                                            ...
                                                            <ul class="list-group">
                                                                <li
                                                                    ...
                                                                    <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1"
                                                                        id="dropdownSignIn">
                                                                        <span>Sign In</span>
                                                                        <img src="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/down-arrow.svg"
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-signin-cover">
                                                                            <span>Cover</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-signin-illustration">
                                                                ...
                                                                <li
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-signup-basic">
                                                                            <span>Basic</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-signup-cover">
                                                                            <span>Cover</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-signup-illustration">
                                                                            <span>Illustration</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-reset-basic">
                                                                            <span>Basic</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-reset-cover">
                                                                            <span>Cover</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-reset-illustration">
                                                                            <span>Illustration</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-lock-basic">
                                                                            <span>Basic</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-lock-cover">
                                                                            <span>Cover</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-lock-illustration">
                                                                            <span>Illustration</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-verification-basic">
                                                                            <span>Basic</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-verification-cover">
                                                                            <span>Cover</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-verification-illustration">
                                                                            <span>Illustration</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                                <li
                                                                    ...
                                                                    <div class="dropdown-menu mt-0 py-3 px-2"
                                                                        ...
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-error404">
                                                                            <span>404</span>
                                                                        </a>
                                                                        <a class="dropdown-item ps-3 border-radius-md mb-1"
                                                                            href="/authentication-error500">
                                                                            <span>500</span>
                                                                        </a>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div class="row d-lg-none">
                                                        <div class="col-12 d-flex justify-content-center flex-column">
                                                            ...
                                                            <a href="/authentication-signin-basic"
                                                                class="dropdown-item border-radius-md">
                                                                Basic
                                                            </a>
                                                            <a href="/authentication-signin-cover"
                                                                class="dropdown-item border-radius-md">
                                                                Cover
                                                            </a>
                                                            <a href="/authentication-signin-illustration"
                                                                class="dropdown-item border-radius-md">
                                                                Illustration
                                                            </a>
                                                            <h6
                                                            ...
                                                            <a href="/authentication-signup-basic"
                                                                class="dropdown-item border-radius-md">
                                                                Basic
                                                            </a>
                                                            <a href="/authentication-signup-cover"
                                                                class="dropdown-item border-radius-md">
                                                                Cover
                                                            </a>
                                                            <a href="/authentication-signup-illustration"
                                                                class="dropdown-item border-radius-md">
                                                                Illustration
                                                            </a>
                                                            <h6
                                                            ...
                                                            <a href="/authentication-reset-basic"
                                                                class="dropdown-item border-radius-md">
                                                                Basic
                                                            </a>
                                                            <a href="/authentication-reset-cover"
                                                                class="dropdown-item border-radius-md">
                                                                Cover
                                                            </a>
                                                            <a href="/authentication-reset-illustration"
                                                                class="dropdown-item border-radius-md">
                                                                Illustation
                                                            </a>
                                                            <h6
                                                            ...
                                                            <a href="/authentication-lock-basic"
                                                                class="dropdown-item border-radius-md">
                                                                Basic
                                                            </a>
                                                            <a href="/authentication-lock-cover"
                                                                class="dropdown-item border-radius-md">
                                                                Cover
                                                            </a>
                                                            <a href="/authentication-lock-illustration"
                                                                class="dropdown-item border-radius-md">
                                                                Illustration
                                                            </a>
                                                            <h6
                                                            ...
                                                            <a href="/authentication-verification-basic"
                                                                class="dropdown-item border-radius-md">
                                                                Basic
                                                            </a>
                                                            <a href="/authentication-verification-cover"
                                                                class="dropdown-item border-radius-md">
                                                                Cover
                                                            </a>
                                                            <a href="/authentication-verification-illustration"
                                                                class="dropdown-item border-radius-md">
                                                                Illustration
                                                            </a>
                                                            <h6
                                                            ...
                                                            <a href="/authentication-error404"
                                                                class="dropdown-item border-radius-md">
                                                                404
                                                            </a>
                                                            <a href="/authentication-error500"
                                                                class="dropdown-item border-radius-md">
                                                                500
                                                            </a>
                                                        </div>
                                                                ...
                                                                <a class="dropdown-item py-2 ps-3 border-radius-md"
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div>
                                                                                <p
                                                                                    class="dropdown-header text-dark p-0">
                                                                                    Kanban</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li
                                                                ...
                                                                <a class="dropdown-item py-2 ps-3 border-radius-md"
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <div class="icon h-10 me-3 d-flex mt-1">
                                                                            <i
                                                                                class="ni ni-laptop text-gradient text-primary"></i>
                                                                        </div>
                                                                        <div
                                                                            class="w-100 d-flex align-items-center justify-content-between">
                                                                            <div>
                                                        ...
                                                        <div class="col-12 px-4 py-2">
                                                            <div class="row">
                                                                <div class="col-6 position-relative">
                                                                    ...
                                                                    <a href="/ecommerce-orders-list"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Order List</span>
                                                                    </a>
                                                                    <a href="/ecommerce-orders-details"
                                                                        class="dropdown-item border-radius-md">
                                                                    ...
                                                                    <a href="/ecommerce-overview"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Overview</span>
                                                                    </a>
                                                                    <a href="/ecommerce-referral"
                                                                        class="dropdown-item border-radius-md">
                                                                ...
                                                                <div class="col-6 position-relative">
                                                                    ...
                                                                    <a href="/ecommerce-products-new-product"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">New Product</span>
                                                                    </a>
                                                                    <a href="/ecommerce-products-edit-product"
                                                                        class="dropdown-item border-radius-md">
                                                                        <span class="ps-3">Edit Product</span>
                                                                    </a>
                                                                    <a href="/ecommerce-products-page"
                                                                        class="dropdown-item border-radius-md">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div>
                                                                            <h6
                                                                                ...
                                                                                Getting Started</h6>
                                                                            <span class="text-sm">All about overview,
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div>
                                                                            <h6
                                                                                class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0">
                                                                                Foundation</h6>
                                                                            <span class="text-sm">See our colors, icons
                                                                                and typography</span>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div>
                                                                            <h6
                                                                                class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0">
                                                                                Components</h6>
                                                                            <span class="text-sm">Explore our
                                                                                collection of fully designed
                                                                                components</span>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div>
                                                                        <h6
                                                                            class="dropdown-header text-dark font-weight-bolder d-flex align-items-center p-0">
                                                                            Components</h6>
                                                                        <span class="text-sm">Explore our collection
                                                                            of fully designed components</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a class="dropdown-item py-2 ps-3 border-radius-md"
                                        ...
                                        <div class="ps__rail-x" style="width: 925px; left: 0px; bottom: 0px;">
                                            <div class="ps__thumb-x" tabindex="0"
                                                style="left: 0px; width: 847px;"></div>
                                        </div>
                                        <div class="ps__rail-y" style="top: 0px; height: 39px; right: 0px;">
                                            <div class="ps__thumb-y" tabindex="0"
                                                style="top: 0px; height: 3px;"></div>
                                        </div>
                                    </div>
                                </div>
                            </nav>
                        ...
                        <div class="row">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <img src="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/shapes/pattern-lines.svg"
                                        alt="pattern-lines" class="position-absolute opacity-4 start-0">
                                    <div class="position-relative">
                                        <img class="max-width-500 w-100 position-relative z-index-2"
                                            src="https://soft-ui-dashboard-pro-laravel.creative-tim.com/assets/img/illustrations/rocket-white.png"
                                            alt="rocket">
                                    </div>
